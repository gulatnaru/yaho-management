 ...
 * 1. 후보 목록(listScheduledClassCandidates / listActiveChildCandidates)에 프리필 id가
 ...
 *   (listScheduledClassCandidates 가 표시상 ENDED 인 클래스도 후보에서 제외하므로).
 * - 그 외(=미래 SCHEDULED): 모든 좌석 상태를 후보에 포함하므로 경고하지 않는다.
 */
