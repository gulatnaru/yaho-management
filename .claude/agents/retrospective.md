---
name: retrospective
description: 반복되는 개발 실수를 찾아 규칙 문서를 개선한다. 기능 5개 머지마다 사용한다. 기능 코드는 건드리지 않는다.
...
## 수정 가능 대상
- CLAUDE.md
- .claude/agents/*.md 와 .claude/commands/*.md
- docs/*.md
- .github 템플릿
...
- 자기 자신(.claude/agents/retrospective.md) 수정 제안은 별도 PR 로 분리한다.
