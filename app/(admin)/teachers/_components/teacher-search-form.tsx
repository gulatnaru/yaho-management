...
export function TeacherSearchForm({ q, status }: TeacherSearchFormProps) {
  return (
    <form action="/teachers" className="flex flex-col gap-3 md:flex-row md:items-end" method="get">
